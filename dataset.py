...
def create_dataset(dataset_dir, ann_file, batch_size, state, num_cam=6, K=6):
    ...
    if state == 'train':
        ...
        dataset = ds.GeneratorDataset(dataset_generator, column_names=columns_names_list, num_parallel_workers=1, shuffle=False)
